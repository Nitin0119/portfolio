  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      <div className="container mx-auto px-6 relative z-10 max-w-1200 flex flex-col lg:flex-row items-center justify-between gap-16">
        ...
        <div className="w-full lg:w-[55%] flex flex-col items-start">
          <motion.div
            ...
            className="font-mono text-accent mb-2 text-sm md:text-base flex items-center gap-2"
          >
            <span>&gt;</span>
          ...
          <motion.div
            ...
            className="w-full my-1 relative cursor-pointer"
          >
            <TextPressure
              text="Nitin Yadav"
              flex={false}
          ...
          <motion.div
            ...
            className="text-lg md:text-xl text-text-secondary max-w-2xl mb-8 leading-relaxed font-sans"
          >
            <TypewriterText />
            <div className="mt-3">
          ...
          >
            <MagneticButton>
              <a 
                ...
                className="inline-block bg-text-primary text-bg px-8 py-3 rounded-[12px] font-medium transition-colors hover:bg-accent hover:text-bg"
              >
                View Work
              </a>
            </MagneticButton>
            <MagneticButton>
              <a 
                ...
                className="inline-block px-8 py-3 rounded-[12px] font-medium border border-border text-text-primary transition-colors hover:border-accent hover:text-accent"
              >
                Let's Talk
              </a>
            </MagneticButton>
      ...
      >
        ...
        >
          <span className="text-xs uppercase tracking-widest text-text-muted font-mono group-hover:text-accent transition-colors">Scroll</span>
          <motion.div
            animate={{ y: [0, 8, 0] }}
